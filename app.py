...
# หน้าตาเว็บ
# ---------------------------------------------------------------------------
st.title("📊 สรุปรายได้ค่าใช้จ่ายร้านค้าออนไลน์")
...
with tab_lzd_exp:
    ...
    if files_lzd_exp:
        ...
        if df_lzd_exp.empty:
            ...
            st.download_button(
                label="📥 ดาวน์โหลดไฟล์ Excel",
                data=output_lzd_exp.getvalue(),
                file_name="ค่าใช้จ่าย_Lazada.xlsx",
                mime="application/vnd.ms-excel",
                key="lzd_exp_download",
            )
